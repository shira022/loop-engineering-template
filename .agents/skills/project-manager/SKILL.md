...
`/home/shira/project/repo-registry.yaml` を読み込み、指定されたプロジェクト名で情報を検索します。

```yaml
# repo-registry.yaml フォーマット例
- name: my-app
  path: /home/shira/project/my-app/repo-my-app
  visibility: public
  language: typescript
  framework: next.js
...
```bash
cd /home/shira/project/<name>/repo-<name>
...
# worktree を作成
WORKTREE_PATH="/home/shira/project/<name>/worktrees/$BRANCH"
...
gh pr create \
  --repo "/home/shira/project/<name>/repo-<name>" \
  --base main \
  --head "$BRANCH" \
...
for repo in /home/shira/project/*/repo-*; do
...
```
=== my-app ===
/home/shira/project/my-app/repo-my-app  main (detached)
/home/shira/project/my-app/worktrees/task/add-auth-1717200000  task/add-auth-1717200000

=== api-server ===
/home/shira/project/api-server/repo-api-server  main (detached)
/home/shira/project/api-server/worktrees/task/fix-timeout-1717300000  task/fix-timeout-1717300000
```
